...
class FingerprintGenerator(object):
    ...
    def fit_predict(self, X, y=None):
        ...
        for batch in np.unique(batches):
            ...
            log_resource_utilization(f"Processing Batch {batch}", data_processed=len(X_batch), start_time=start_time)
        ...
        unique_fingerprint=len(set(result))
        print(f"total fingerprints: {unique_fingerprint}")
        log_resource_utilization("Fingerprint Generation Complete", data_processed=len(X), start_time=start_time)
    ...
    def _fit_single_batch_(self, X, y=None):
        ...
        log_resource_utilization("fingerprinting", data_processed=data_processed, start_time=start_time)
        print(f"Fingerprints created: {len(fingerprints)} fingerprints generated.")
