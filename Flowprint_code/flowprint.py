...
class FlowPrint(object):
    ...
    def __init__(self, batch=150, window=30, correlation=0.1, similarity=0.9,
                 threshold=0.1):
        """FlowPrint object creates fingerprints from mobile network traffic.
    ...
    def update(self, X, y=None):
        ...
        #log_resource_utilization("after updating the fingerprints label", data_processed=len(X), start_time=start_time)
    ...
    def predict(self, X, y=None, default='common'):
        ...
        # Return result
        #log_resource_utilization("After fingerprintpred", data_processed=len(X), start_time=start_time)
        return result
    ...
    def fingerprint(self, X, y=None):
        ...
        #log_resource_utilization("after fingerprint creation", data_processed=len(X), start_time=start_time)
    ...
    def recognize(self, X, y=None, default='common'):
        ...
        #log_resource_utilization("after recongintion", data_processed=len(X), start_time=start_time)
    ...
    def detect(self, X, y=None, threshold=None):
        ...
        #log_resource_utilization("after detection", data_processed=len(X), start_time=start_time)
